  ...
  return (
    <div
      className="
        ...
        h-[400px] lg:row-span-2 md:row-span-2
        border border-white/10 
        bg-gradient-to-br from-white/5 via-white/0 to-white/5
        backdrop-blur-[2px]                     
        shadow-[0_0_15px_0_rgba(0,0,0,0.35)]
      ...
      <div className="relative z-10 flex h-full flex-col p-6 text-white">
        <span
          className="
            ...
            rounded-full border border-pink-500/70
            bg-pink-800/40 px-4 py-1 text-sm font-medium
            backdrop-blur-sm
          "
        >
        ...
        <p className="text-lg font-display-text">{price}</p>
      </div>
    </div>
  );
}
